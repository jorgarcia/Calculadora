...
pantalla2=document.getElementById("textoPantalla2"); //elemento pantalla de salida
...
function operar(s) {
         ...
         pantalla2.innerHTML=s; //MOSTRAR en pantalla la operacion que se realiza
...
function borradoTotal() {
         ...
         pantalla2.innerHTML=""; //poner pantalla vacia
...
function teclado (elEvento) { 
         ...
         if (k==186) {operar('*')} //tecla multiplicación
         if (k==107) {operar('+')} //tecla suma
         if (k==187) {operar('+')}
         if (k==109) {operar('-')} //tecla resta
         if (k==189) {operar('-')} //tecla resta
